...
export default function UpdateFlight() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-purple-100 to-pink-300"> {/* Example of an aesthetically pleasing gradient */}
