...
import OnlyAdminPrivateRoute from './components/OnlyAdminPrivateRoute'; // Ensure this is imported correctly
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route element={<PrivateRoute />}>
          ...
          <Route path='/ticket-downloadable' element={<TicketDownloadable />} /> {/* Moved here */}
        </Route>
